...
public class MainActivity extends AppCompatActivity implements SongChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int options = View.SYSTEM_UI_FLAG_FULLSCREEN | View.SYSTEM_UI_FLAG_FULLSCREEN;
        ...
        playerSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                ...
                // seek bar is starting continusly
                if(b){
    ...
    private void getMusicFiles(){
        ...
        if(cursor == null){
            ...
            while(cursor.moveToNext()){
                ...
                // getColumnCount becomes getColumnIndex now
    ...
    public void onChanged(int position) {
        ...
        mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                Log.e("aasfaafasf","as"+getTotalDuration);
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.e("aasfaafasf","as"+getCurrentDuration);
                        String generateDuration = String.format(Locale.getDefault(), "%02d:%02d",
